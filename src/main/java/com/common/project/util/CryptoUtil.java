...
public   class  CryptoUtil {
    public static final String DEFAULT_SECRET_KEY1 = "?870643fb-81cb-408d-a785-0792dde4038e";
    ...
    public static void main(String[] args) {
        CryptoUtil test = new CryptoUtil();
        String oldString = "490113176";

        String SPKEY = DEFAULT_SECRET_KEY1;
